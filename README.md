...
Ничего скачивать и устанавливать не надо, проект задеплоен на Streamlit []. Образец данных можно посмотреть внизу, но вообще поддерживается генерация пробных данных.
